...
public class ShrineListTier2 : MonoBehaviour
{
    [SerializeField] ShrineControllerTier2 _shrineController;
    ...
    public void SetHealth02(int itemNumber)
    {
        _shrineController._itemNames[itemNumber].text = "Health II";
        _shrineController._itemDescriptions[itemNumber].text = "Increase maximum health by a moderate amount, and heal some health..";
        int itemCost = Random.Range(4, 11);
        _shrineController._itemCost[itemNumber].text = "";
        _shrineController._itemCost[itemNumber].text = itemCost + "";
        _shrineController._itemButton[itemNumber].onClick.AddListener(delegate { IncreasePlayerHealth(15, itemCost, itemNumber); });
    ...
    public void SetSpeed02(int itemNumber)
    {
        _shrineController._itemNames[itemNumber].text = "Speed II";
        _shrineController._itemDescriptions[itemNumber].text = "Increase maximum speed by a moderate amount.";
        int itemCost = Random.Range(8, 13);
        _shrineController._itemCost[itemNumber].text = "";
        _shrineController._itemCost[itemNumber].text = itemCost + "";
        _shrineController._itemButton[itemNumber].onClick.AddListener(delegate { IncreasePlayerSpeed(0.5f, itemCost, itemNumber); });
    ...
    public void SetShield(int itemNumber)
    {
        ...
        int itemCost = Random.Range(16, 19);
        _shrineController._itemCost[itemNumber].text = "";
        _shrineController._itemCost[itemNumber].text = itemCost + "";
    ...
    public void SetDoubleJump(int itemNumber)
    {
        ...
        int itemCost = Random.Range(15, 19);
        _shrineController._itemCost[itemNumber].text = "";
        _shrineController._itemCost[itemNumber].text = itemCost + "";
    ...
    public void SetFireRune(int itemNumber)
    {
        ...
        int itemCost = Random.Range(15, 26);
        _shrineController._itemCost[itemNumber].text = "" + itemCost;
