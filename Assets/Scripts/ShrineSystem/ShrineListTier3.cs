...
public class ShrineListTier3 : MonoBehaviour
{
    [SerializeField] ShrineControllerTier3 _shrineController;
    ...
    public void SetHealth03(int itemNumber)
    {
        _shrineController._itemNames[itemNumber].text = "Health III";
        _shrineController._itemDescriptions[itemNumber].text = "Increase maximum health by a large amount, and heal some health.";
        int itemCost = Random.Range(10, 19);
        _shrineController._itemCost[itemNumber].text = "";
        _shrineController._itemCost[itemNumber].text = itemCost + "";
        _shrineController._itemButton[itemNumber].onClick.AddListener(delegate { IncreasePlayerHealth(30, itemCost, itemNumber); });
    ...
    public void SetSpeed03(int itemNumber)
    {
        _shrineController._itemNames[itemNumber].text = "Speed II";
        _shrineController._itemDescriptions[itemNumber].text = "Increase maximum speed by a large amount.";
        int itemCost = Random.Range(12, 19);
        _shrineController._itemCost[itemNumber].text = "";
        _shrineController._itemCost[itemNumber].text = itemCost + "";
        _shrineController._itemButton[itemNumber].onClick.AddListener(delegate { IncreasePlayerSpeed(0.75f, itemCost, itemNumber); });
    ...
    public void SetShield(int itemNumber)
    {
        ...
        int itemCost = Random.Range(14, 17);
        _shrineController._itemCost[itemNumber].text = "";
        _shrineController._itemCost[itemNumber].text = itemCost + "";
    ...
    public void SetDoubleJump(int itemNumber)
    {
        ...
        int itemCost = Random.Range(12, 16);
        _shrineController._itemCost[itemNumber].text = "";
        _shrineController._itemCost[itemNumber].text = itemCost + "";
    ...
    public void SetFireRune(int itemNumber)
    {
        ...
        int itemCost = Random.Range(15, 21);
        _shrineController._itemCost[itemNumber].text = "" + itemCost;
