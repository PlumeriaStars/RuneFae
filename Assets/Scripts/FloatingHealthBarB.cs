...
public class FloatingHealthBarB : MonoBehaviour
{
    ...
    [SerializeField] BossBehavior _enemyController;
    [SerializeField] Camera _cinemaCamera;

    private void Start()
    {
        _enemyHealthBar.maxValue = _enemyController.gameObject.GetComponent<BossBehavior>().GetEnemeyHealth();
        _enemyHealthBar.value = _enemyController.gameObject.GetComponent<BossBehavior>().GetEnemeyHealth();
    }
