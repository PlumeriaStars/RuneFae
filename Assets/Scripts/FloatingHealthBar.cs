...
public class FloatingHealthBar : MonoBehaviour
{
    ...
    [SerializeField] GroundEnemy _enemyController;
    [SerializeField] Camera _cinemaCamera;

    private void Start()
    {
        _enemyHealthBar.maxValue = _enemyController.gameObject.GetComponent<GroundEnemy>().GetEnemeyHealth();
    }
    ...
    {
        _enemyHealthBar.value = _enemyController.gameObject.GetComponent<GroundEnemy>().GetEnemeyHealth();
    }
}
